							...
							<div class="col-xs-12" 
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 土地名称</label>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-4"  class="form-control" placeholder=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
												<input type="text" id="form-field-7"  class="form-control date-picker" data-date-format="dd-mm-yyyy" type="text" name="" placeholder=""/>
												<span class="input-group-addon">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
												<input type="text" id="form-field-8"  class="form-control date-picker" data-date-format="dd-mm-yyyy" type="text" name="" placeholder=""/>
												<span class="input-group-addon">
												<i class="fa fa-calendar bigger-110"></i>
												</span>
											</div>	
